( function(){
	...
	*/
	...
	function getMonthNumber(monthName){
		var monthNumber = '';
		switch (monthName) {
			case 'janeiro': monthNumber = '01'; break;
			case 'fevereiro': monthNumber = '02'; break;
			case 'março': monthNumber = '03'; break;
			case 'abril': monthNumber = '04'; break;
			case 'maio': monthNumber = '05'; break;
			case 'junho': monthNumber = '06'; break;
			case 'julho': monthNumber = '07'; break;
			case 'agosto': monthNumber = '08'; break;
			case 'setembro': monthNumber = '09'; break;
			case 'outubro': monthNumber = '10'; break;
			case 'novembro': monthNumber = '11'; break;
			case 'dezembro': monthNumber = '12'; break;
		}
		return 	monthNumber;
	}
	
	var myMonth = 'março';
	console.log('O mês de ' + myMonth + ' é representado pelo número ' + getMonthNumber(myMonth)  + '.');
	myMonth = 'setembro';
	console.log('O mês de ' + myMonth + ' é representado pelo número ' + getMonthNumber(myMonth)  + '.');
	myMonth = 'dezembro';
	console.log('O mês de ' + myMonth + ' é representado pelo número ' + getMonthNumber(myMonth)  + '.');
	...
	*/
	...
	var regexDate = '/(\d\d)\sde\s(\w+)\sde\s(\d\d\d\d)/g'
	...
	*/
	...
	console.log(text.replace(/(\d\d)\sde\s(\w+)\sde\s(\d\d\d\d)/g, replaceDate));
	console.log( '\nReplace de datas:' );
	// ?
})();